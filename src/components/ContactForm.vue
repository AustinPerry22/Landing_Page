<template>
  <section class="row justify-content-center">
    <form class="col-6 form bg-dark p-4 rounded-4" action="https://api.web3forms.com/submit" method="POST">
        ...
        <section class="row justify-content-center">
          ...
          <button class="btn btn-success col-3" type="submit">Submit Form</button>
        </section>
